...
class Dummy_data {
    ...
    var prices1 = SuggestionPrice(2.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices1_1 = SuggestionPrice(2.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices2 = SuggestionPrice(3.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices2_2 = SuggestionPrice(3.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices3 = SuggestionPrice(4.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices3_3 = SuggestionPrice(2.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices4 = SuggestionPrice(2.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices4_4 = SuggestionPrice(3.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices5 = SuggestionPrice(3.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices5_5 = SuggestionPrice(4.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices6 = SuggestionPrice(2.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices6_6 = SuggestionPrice(2.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices7 = SuggestionPrice(3.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices7_7 = SuggestionPrice(3.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices8 = SuggestionPrice(4.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices8_8 = SuggestionPrice(6.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices9 = SuggestionPrice(3.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices9_9 = SuggestionPrice(4.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices10 = SuggestionPrice(2.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices10_10 = SuggestionPrice(2.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices11 = SuggestionPrice(3.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices11_11 = SuggestionPrice(3.5,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices12 = SuggestionPrice(4.0,0)
    @RequiresApi(Build.VERSION_CODES.O)
    var prices12_12 = SuggestionPrice(6.0,0)
    ...
    var potatoesInJumboWithPrices = ProductInShopWithPrices(potatoes, jumbo, prices1, suggestionsPrices1)
    var potatoesInAldiWithPrices = ProductInShopWithPrices(potatoes, aldi, prices2, suggestionsPrices2)
    var potatoesInLidlWithPrices = ProductInShopWithPrices(potatoes, lidl, prices3, suggestionsPrices3)

    var pizzaInJumboWithPrices = ProductInShopWithPrices(pizza, jumbo, prices4, suggestionsPrices4)
    var pizzaInAldiWithPrices = ProductInShopWithPrices(pizza, aldi, prices5, suggestionsPrices5)
    var pizzaInLidlWithPrices = ProductInShopWithPrices(pizza, lidl, prices6, suggestionsPrices6)

    var bananasInJumboWithPrices = ProductInShopWithPrices(bananas, jumbo, prices7, suggestionsPrices7)
    var bananasInAldiWithPrices = ProductInShopWithPrices(bananas, aldi, prices8, suggestionsPrices8)
    var bananasInLidlWithPrices = ProductInShopWithPrices(bananas, lidl, prices9, suggestionsPrices9)

    var eggsInJumboWithPrices = ProductInShopWithPrices(eggs, jumbo, prices10, suggestionsPrices10)
    var eggsInAldiWithPrices = ProductInShopWithPrices(eggs, aldi, prices11, suggestionsPrices11)
    var eggsInLidlWithPrices = ProductInShopWithPrices(eggs, lidl, prices12, suggestionsPrices12)
    ...
    var combo7WithPrices = CombinationWithPrices(arrayListOf(jumbo, aldi, lidl), arrayListOf())
     ...
     constructor () {
        ...
        potatoesInJumboWithPrices = ProductInShopWithPrices(potatoes, jumbo, prices1, suggestionsPrices1)
        potatoesInAldiWithPrices = ProductInShopWithPrices(potatoes, aldi, prices2, suggestionsPrices2)
        potatoesInLidlWithPrices = ProductInShopWithPrices(potatoes, lidl, prices3, suggestionsPrices3)

        pizzaInJumboWithPrices = ProductInShopWithPrices(pizza, jumbo, prices4, suggestionsPrices4)
        pizzaInAldiWithPrices = ProductInShopWithPrices(pizza, aldi, prices5, suggestionsPrices5)
        pizzaInLidlWithPrices = ProductInShopWithPrices(pizza, lidl, prices6, suggestionsPrices6) // the cheap one

        bananasInJumboWithPrices = ProductInShopWithPrices(bananas, jumbo, prices7, suggestionsPrices7)
        bananasInAldiWithPrices = ProductInShopWithPrices(bananas, aldi, prices8, suggestionsPrices8)
        bananasInLidlWithPrices = ProductInShopWithPrices(bananas, lidl, prices9, suggestionsPrices9)

        eggsInJumboWithPrices = ProductInShopWithPrices(eggs, jumbo, prices10, suggestionsPrices9)
        eggsInAldiWithPrices = ProductInShopWithPrices(eggs, aldi, prices11, suggestionsPrices10)
        eggsInLidlWithPrices = ProductInShopWithPrices(eggs, lidl, prices12, suggestionsPrices11)
